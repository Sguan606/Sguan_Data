...
void ST7789_Test(void)
{
	while(1)
	{
		ST7789_Fill_Color(WHITE);
			HAL_Delay(500);
			ST7789_WriteString(10, 20, "The screen Test!!!", Font_11x18, RED, WHITE);
			HAL_Delay(1000);
...
//			HAL_Delay(1000);
			...
			ST7789_WriteString(10, 10, "Justers", Font_16x26, GBLUE, WHITE);
			ST7789_WriteString(10, 50, "Welcome to!", Font_7x10, RED, WHITE);
			ST7789_WriteString(10, 75, "my test time!", Font_11x18, YELLOW, WHITE);
			ST7789_WriteString(10, 100, "Jiangsu University of Science and Technology", Font_16x26, MAGENTA, WHITE);
			HAL_Delay(5000);

			ST7789_Fill_Color(BLUE);
			ST7789_WriteString(10, 10, "JUST do it!", Font_11x18, YELLOW, BLACK);
			ST7789_DrawRectangle(30, 30, 100, 100, WHITE);
			HAL_Delay(1000);

			ST7789_Fill_Color(LBBLUE);
			ST7789_WriteString(10, 10, "Stm32cudeIDE works", Font_11x18, YELLOW, BLACK);
			ST7789_DrawFilledRectangle(30, 30, 50, 50, WHITE);
			HAL_Delay(1000);

			ST7789_Fill_Color(LGRAY);
			ST7789_WriteString(10, 10, "My screen is ST7789", Font_11x18, YELLOW, BLACK);
			ST7789_DrawCircle(60, 60, 25, WHITE);
			HAL_Delay(1000);

			ST7789_Fill_Color(LIGHTGREEN);
			ST7789_WriteString(10, 10, "240x280 RGB.led", Font_11x18, YELLOW, BLACK);
			ST7789_DrawFilledCircle(60, 60, 25, WHITE);
			HAL_Delay(1000);

			ST7789_Fill_Color(YELLOW);
			ST7789_WriteString(10, 10, "MCU stm32F103C8T6 ", Font_11x18, YELLOW, BLACK);
			ST7789_DrawTriangle(30, 30, 30, 70, 60, 40, WHITE);
			HAL_Delay(1000);

			ST7789_Fill_Color(RED);
			ST7789_WriteString(10, 10, "Welcome,  My JUST!", Font_11x18, YELLOW, BLACK);
